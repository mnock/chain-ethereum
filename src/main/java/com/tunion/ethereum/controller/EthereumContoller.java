package com.tunion.ethereum.controller;
...
public class EthereumContoller {

    private static Logger logger = LoggerFactory.getLogger(EthereumContoller.class);
    ...
    public Results createAddress(HttpServletRequest request)
    {
        ...
        try{
            ...
            results = ethereumService.createAddress(JavaReflectUtil.obj2str(searchParams.get("accountName")));
    ...
    public Results withdrawalCash(HttpServletRequest request)
    {
        ...
        try{
            ...
            results = ethereumService.withdrawalCash(JavaReflectUtil.obj2str(searchParams.get("accountName")),JavaReflectUtil.obj2str(searchParams.get("accountAddress")),
    ...
    public Results getBalance(HttpServletRequest request)
    {
        ...
        try{
            ...
            results = ethereumService.getBalance(JavaReflectUtil.obj2str(searchParams.get("accountName")));
