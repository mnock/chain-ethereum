...
public class SuperCoin_sol_SuperToken extends Contract {
    ...
    protected SuperCoin_sol_SuperToken(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected SuperCoin_sol_SuperToken(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<SuperCoin_sol_SuperToken> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _supply, String _name, String _symbol, BigInteger _decimals) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(_supply),
                ...
                new Uint8(_decimals)));
        return deployRemoteCall(SuperCoin_sol_SuperToken.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<SuperCoin_sol_SuperToken> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger _supply, String _name, String _symbol, BigInteger _decimals) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(_supply),
                new Utf8String(_name),
                new Utf8String(_symbol),
                new Uint8(_decimals)));
        return deployRemoteCall(SuperCoin_sol_SuperToken.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static SuperCoin_sol_SuperToken load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new SuperCoin_sol_SuperToken(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static SuperCoin_sol_SuperToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new SuperCoin_sol_SuperToken(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
